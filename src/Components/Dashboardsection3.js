...
const staticdata = [
        {
          id: 1,
          name:"Sophia Gregory",
          category:<div className='text-[#28c76f] py-1 font-["Inter"] text-xs font-semibold pl-2 pr-4 bg-[#28c76f1f] flex items-center justify-center text-center rounded-full w-fit'>
  <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="#28c76f" class="bi bi-dot" viewBox="0 0 14 14"> <path d="M8 9.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3z"/> </svg>
  <h1>Guest</h1>
</div>,
 date: "Jan 13, 2022",
        ...
        },
        {
          id: 1,
          name:"Jack Paul",
           category:<div className='text-[#F9A221] py-1 font-["Inter"] text-xs font-semibold pl-2 pr-4 bg-[#DCB21E33] flex items-center justify-center rounded-full w-fit'>
  <svg
...
date: "Jan 13, 2022",
        ...
        },
         {
          id: 1,
          name:"Mr Aalexandar",
          category:<div className='text-[#28c76f] py-1 font-["Inter"] text-xs font-semibold pl-2 pr-4 bg-[#28c76f1f] flex items-center justify-center  rounded-full w-fit'>
   <svg
  xmlns="http://www.w3.org/2000/svg"
  width="30"
  height="30"
...
const Dashboardsection3 = () => {
  ...
  return (
    ...
    <div className='flex flex-row sm:flex sm:flex-col sm:gap-3 sm:items-start justify-between items-center px-[19px] py-[19px]'>
      <h1 className='font-poppins text-[#101828] text-lg font-medium leading-7'>New User Registrations</h1>
    <div className='flex flex-row md:hidden items-center gap-2'>
  ...
  <path d="M22 22L20 20" stroke="#898E95" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
   ...
   <div className='bg-[#ECECEC] p-1 sm:hidden rounded-md flex gap-2 justify-center items-center'>
          ...
          <table class="font-dm w-full text-sm text-left text-gray-500  bg-white border ">
            <thead class=" font-['Inter']  text-xs  uppercase bg-[#EAECF0] font-normal text-[#818181]  rounded-t-xl  border-b">
              <tr className="text-center">
                <th scope="col" className='pl-[30px] py-[13px] '>
                <div className="flex gap-2 items-center sm:w-40">
                 <h1>Name</h1>
                 </div>
                </th>
                <th scope="col">
                ...
                <th scope="col" >
                <div className="flex gap-1 items-center sm:w-44">
                 <h1>Email</h1>
            ...
            <tbody>
              {staticdata.map((val, ind) => (
                <tr class="font-['Inter'] h-[72px] hover:bg-[#f6f6f6] border-b justify-between items-center  py-4 font-normal text-xs text-[#667085]">
                  <th
                    scope="row"
                    class="pl-[30px] py-[13px]  cursor-pointer items-center text-sm font-['Inter'] font-medium whitespace-nowrap text-[#101828]"
                  >
                  {val.name}
                  </th>
                  ...
                  <td>
                    <div className=" items-center justify-center flex gap-2 cursor-pointer">
                      <div className='text-[#EA4335] py-2 font-["Inter"] text-xs font-semibold pl-2 pr-4 bg-[#EA433533] flex items-center gap-1 justify-center rounded-full w-fit'>
 <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="#EA4335" class="bi bi-x-circle" viewBox="0 0 16 16"> <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/> <path d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z"/> </svg>
 <h1>Decline</h1>
</div> 
<div className='text-[#28c76f] py-2 font-["Inter"] text-xs font-semibold pl-2 pr-4 bg-[#28c76f1f] flex items-center justify-center gap-1 rounded-full w-fit'>
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="14"
    height="14"
